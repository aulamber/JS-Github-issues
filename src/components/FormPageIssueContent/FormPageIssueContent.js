...
export function FormPageIssueContentComponent({
  classes,
  issues,
  loadIssues,
  theme,
            ...
            return (
              <AsyncCreatableSelect
                ...
                onChange={newValue => {
                  ...
                  localStorage.setItem('title', newValue ? newValue.label : '');
                }}
              />
            );
          }}
...
FormPageIssueContentComponent.propTypes = {
  classes: PropTypes.shape().isRequired,
  theme: PropTypes.shape().isRequired,
};

export const FormPageIssueContent = withStyles(
  theme => ({
    input: {
      display: 'flex',
      padding: 0,
